...
function prepareTransactionData() {
    const inputs = '{"function": "linkArweaveAddress", "arweave_owner": "", "arweave_sig": ""}'.split("").map((char) => char.charCodeAt(0))
    const transaction = {
        type: 2,
        inputs: inputs,
        contract: "0x0fb8efa3e682f9a918b39204f0ef99ac88503ff352a1fb700e8199bf4437cc02"
